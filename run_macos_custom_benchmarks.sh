...
./run_custom_single.sh macos-pbs
deactivate

conda run  --prefix ./local_envs/cforge_env --live-stream ./run_custom_single.sh macos-conda-forge

source ./local_envs/brew_env/bin/activate
./run_custom_single.sh macos-homebrew
deactivate

source ./local_envs/org_env/bin/activate
./run_custom_single.sh macos-python-org
deactivate